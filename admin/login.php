...
<div class="container">
  <div class="row">
    ...
    <div class="container">
    <button type="submit" class="btn btn-success" style="margin-top:-800px; margin-left:1100px;"><a href="../login.php" class="text-light">TEACHER</a></button>
    <button type="submit" class="btn btn-success" style="margin-top:-846px; margin-left:1000px;"><a href="../student_attend.php" class="text-light">STUDENT </a></button>

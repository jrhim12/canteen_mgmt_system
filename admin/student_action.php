...
if(isset($_POST["action"]))
{
	if($_POST["action"] == "fetch")
	{
		...
		if(isset($_POST["search"]["value"]))
		{
			...
			OR tbl_student.mobile LIKE "%'.$_POST["search"]["value"].'%" 
	...
	if($_POST["action"] == 'Add' || $_POST["action"] == "Edit")
	{
		...
		{
			$error_mobile = 'Student Mobile Number is required';
			$error++;
		}
		else
		{
		...
		else
		{
			if($_POST["action"] == 'Add')
			{
				...
				(student_name, student_roll_number, mobile, student_dob, student_grade_id) 
				VALUES (:student_name, :student_roll_number, :mobile, :student_dob, :student_grade_id)
				";
